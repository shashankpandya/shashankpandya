...
| 🚀 **Currently Building** | 🎓 **Actively Learning** | 💡 **Exploring** |
|:---:|:---:|:---:|
| **Aira** - AI Interview Coach | Kubernetes & Microservices | Agentic AI Workflows |
| **LegalRAG** - Legal AI System | Advanced MLOps & LLMOps | Vector Databases |
| Open Source Contributions | Distributed Systems | Multi-modal LLMs |
| | System Design | DeFi & Web3 |
...
|:---:|:---:|:---:|
| 🧠 LLMs & GPT Models | 🌐 Full Stack Web Apps | 📜 Solidity & EVM |
| 🔍 RAG Systems | 📱 React & Next.js | 🌿 DeFi Protocols |
| 🔗 LangChain & Agents | ⚙️ Node.js & Express | 📦 Smart Contracts |
| 🖼️ Computer Vision | 🗄️ MongoDB & SQL | 🔐 Web3 Integration |
...
**🔭 Open To:** `AI/ML Engineering` `Backend Development` `Product Engineering` `Research Internships` `Full-time Roles`
...
_Built with ❤️ by **Shashank Pandya**_
